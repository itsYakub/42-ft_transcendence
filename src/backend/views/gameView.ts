...
export function gameView(games: Game[], user: User): string {
	...
	<div class="w-full h-full bg-gray-900 m-auto">
		<div class="flex flex-row pt-8 justify-center gap-2">
			<fieldset class="w-100 h-107 flex flex-col gap-8 border border-gray-700 rounded-lg p-3 pb-5">
			...
			<div class="flex flex-col gap-4">
				...
				<fieldset class="w-85 flex flex-col grow items-center border border-gray-700 rounded-lg p-3 pb-5 gap-8">
