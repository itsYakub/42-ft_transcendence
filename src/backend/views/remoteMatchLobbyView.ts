...
function spinnerHtml(gamers: Gamer[]) {
	...
	<div class="my-auto pb-20">
		<svg aria-hidden="true" class="w-8 h-8 text-center animate-spin text-stone-700 fill-fuchsia-800" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
