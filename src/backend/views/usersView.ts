...
export function usersView(users: ShortUser[]): string {
	...
	<div class="flex flex-col items-center gap-4">
		<div class="text-gray-300 mt-8 text-center inline-block align-middle text-3xl rounded-lg bg-stone-700 px-3 py-1">%%TEXT_USERS_TITLE%%</div>
		<fieldset class="border border-fuchsia-800 rounded-lg p-2">
...
function switcherHtml(): string {
	return `
		<div class="flex flex-row justify-center items-center mb-2 gap-2">
			<div class="disabled p-2 rounded-lg bg-fuchsia-800 text-gray-300 px-2 pt-1 pb-0">All</div>
