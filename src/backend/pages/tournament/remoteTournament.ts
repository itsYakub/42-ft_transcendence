...
export function remoteTournamentHtml({ user, language }): string {
	...
	<div class="w-full h-full bg-gray-900 m-auto text-center">
		...
		<div class="flex flex-col mx-auto text-center items-center content-center">
			<form id="newTournamentForm" class="w-75">
				...
				<input type="text" name="p4Name" required="true" placeholder="%%TOURNAMENT_PLAYER_TEXT%% 4" class="my-4 border rounded-lg block w-full p-2.5 bg-gray-800 border-gray-700 placeholder-gray-600 text-gray-300e">
